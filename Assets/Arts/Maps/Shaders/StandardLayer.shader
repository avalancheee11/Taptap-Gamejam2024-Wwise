	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 triplanar63 = TriplanarSampling63( _DetailNormalMap, WorldPosition, ase_worldNormal, 1.0, WorldSpaceDeposit48, _2ndNormalPower, 0 );
				float3 tanTriplanarNormal63 = mul( ase_worldToTangent, triplanar63 );
...
/*ASEBEGIN
Version=18900
0;73;1920;928;5627.064;50.61152;2.310409;True;False
...
ASEEND*/
//CHKSM=448E910D6FE1371515322EF2A9D49DA20293CAB0